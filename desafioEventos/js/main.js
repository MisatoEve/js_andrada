            ...
            while (accionUsuario != 99) {
                ...
                switch (accionUsuario) {
                    ...
                    case 4:
                        ...
                        alert(`Agregamos al carrito el producto ${conjuntoJuegos[4].titulo}`)
                        break;
                    case 5:
                        carrito.push(conjuntoJuegos[5])
                        alert(`Agregamos al carrito el producto ${conjuntoJuegos[5].titulo}`)
                        break;  
                    case 6:
                        carrito.push(conjuntoJuegos[6])
                        alert(`Agregamos al carrito el producto ${conjuntoJuegos[6].titulo}`)
                        break;
                    case 7:
                        carrito.push(conjuntoJuegos[7])
                        alert(`Agregamos al carrito el producto ${conjuntoJuegos[7].titulo}`)
                        break;
                    case 8:
                        carrito.push(conjuntoJuegos[8])
                        alert(`Agregamos al carrito el producto ${conjuntoJuegos[8].titulo}`)
                        break;
                    case 9:
                        carrito.push(conjuntoJuegos[9])
                        alert(`Agregamos al carrito el producto ${conjuntoJuegos[9].titulo}`)
                        break; 
                    case 10:
                        carrito.push(conjuntoJuegos[10])
                        alert(`Agregamos al carrito el producto ${conjuntoJuegos[10].titulo}`)
                        break;             
                    case 11:
                        carrito.push(conjuntoJuegos[11])
                        alert(`Agregamos al carrito el producto ${conjuntoJuegos[11].titulo}`)
                        break;
                    case 12:
                        carrito.push(conjuntoJuegos[12])
                        alert(`Agregamos al carrito el producto ${conjuntoJuegos[12].titulo}`)
                        break;                          
                    default:
...
conjuntoJuegos.forEach((juego)=>{
    ...
    nuevoProducto.innerHTML =  `<article id="${juego.id}" class="card container-fluid" style="width: 28rem;">
                                ...
                                <article class="card-body">
                                    ...
                                    <a href="" class="agregarBtn btn btn-primary click">Agregar al carrito</a>
                                </article>` 
    divProductos.appendChild(nuevoProducto)
})

let btnAgregar = document.getElementsByClassName("agregarBtn")
for (let juegoBoton of btnAgregar){
    juegoBoton.addEventListener("click", ()=>{console.log(`Usted ha comprado este producto`)})
}
